...
class OnPolicyAgent(Agent):
    ...
    def get_action(self, obs: np.ndarray, par_act=None, record: bool = True) -> np.ndarray:
        """
        Return an action given an observation.
        ...
        if(par_act==None):
            ...
            actions, values, log_probs = action_from_policy(obs, self.model.policy,par_act)
        ...
        if record:
            ...
            buf.add(
                ...
                np.reshape(par_act, (1,) + act_shape),
                [0],
    ...
    def save(self, filedir):
        self.model.save(filedir)
        # th.save(self.model, filedir)
